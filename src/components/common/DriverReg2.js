...
import { CardItem, Card, Container, Picker, ListItem, CheckBox, Header, Body, Content, Form, Item, Icon, Input, Label, Button } from 'native-base';
...
class DriverReg2 extends Component {
  ...
  finalRegistration() {
    ...
    axios.post(_baseUrl + '/user', {
      ...
      console.log("Driver registration result :", result.data);
  ...
  render() {
    /**Driver registration page one params */
...
const mapStateToProps = (state) => {
  const { name,
    ...
    states,
    zipcode,
    country } = state.driverDetailsForm;
