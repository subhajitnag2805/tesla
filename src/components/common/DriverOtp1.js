...
class DriverOtp1 extends Component {
    ...
    sendOtp() {
        if (this.state.phoneNumber.trim() === "") {
            ...
            axios.post(_baseUrl + '/user/verifyUser', {
                phoneNumber: this.state.phoneNumber
            }).then((result) => {
                console.log("sendOtp result :", result.data.result);
                        ...
                        <View style={styles.speacearea}>
                            <Form>
                                ...
                                <View style={styles.textCenter}>
                                    <Button rounded style={styles.btnlogin} onPress={this.sendOtp.bind(this)} >
